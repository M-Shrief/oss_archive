...
#     """Get the needed data from Codeberg API into the MetaItem Model"""
#     try:
...
#         # URLs
#         new_meta_item.html_url = f"https://codeberg.org/{meta_item.owner_username}"
#         # Sources
...
#         new_meta_item.owner_updated_at = api_response.get("created_at")
